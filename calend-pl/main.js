...
function getActiveDay(date) {
  ...
  eventDate.innerHTML = date + " " + monthEnd[month] + " " + year;
}

// обновление событий (акт)
